...
void protobuf_AddDesc_event_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013event.proto\022\tdate.door\"0\n\005Event\022\'\n\teve"
    "ntType\030\001 \002(\0162\024.date.door.EventType*#\n\tEv"
    "entType\022\n\n\006RingOn\020\000\022\n\n\006SayBye\020\001", 111);
...
Event::Event()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:date.door.Event)
}
...
Event::Event(const Event& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:date.door.Event)
}
...
Event::~Event() {
  // @@protoc_insertion_point(destructor:date.door.Event)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:date.door.Event)
  for (;;) {
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::date::door::EventType_IsValid(value)) {
            set_eventtype(static_cast< ::date::door::EventType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:date.door.Event)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:date.door.Event)
  return false;
#undef DO_
}
...
void Event::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:date.door.Event)
  // required .date.door.EventType eventType = 1;
  if (has_eventtype()) {
  ...
  // @@protoc_insertion_point(serialize_end:date.door.Event)
}

::google::protobuf::uint8* Event::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:date.door.Event)
  // required .date.door.EventType eventType = 1;
  if (has_eventtype()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:date.door.Event)
  return target;
}
